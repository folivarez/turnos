...
router.post(
  "/jornadas/updateAll",
  isLoggedIn,
  jornada_controller.jornada_update_all
);
...
router.post(
  "/jornadas/update",
  isLoggedIn,
  jornada_controller.jornada_update_estado
);
router.post(
  "/jornadas/completa",
  isLoggedIn,
  jornada_controller.jornada_update_completa
);
...
router.delete(
  "/jornadas/:id/delete",
  isLoggedIn,
  jornada_controller.jornada_delete
);
...
router.get("/v1/public", jornada_controller.jornadas_publicas);

...
router.get(
  "/cantidaddeturnos",
  isLoggedIn,
  admin_controller.cantidadDeTurnosView
);
...
router.post(
  "/veterinarios",
  isLoggedIn,
  veterinario_controller.new_veterinario
);
router.post(
  "/veterinariosNombre",
  veterinario_controller.veterinario_por_nombre
);
router.post(
  "/veterinarios/delete",
  isLoggedIn,
  veterinario_controller.veterinario_delete
);
